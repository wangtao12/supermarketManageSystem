        ...
        <div role="tabpanel" class="tab-pane active" id="basicInfoArea">
            <form class="form-horizontal" style="margin: 20px;" id="basicInfoForm">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="formDatetime DataInput form-control" name="birthday" style="width: 300px;">
                    </div>
                </div>
                <div class="form-group">
...
<script type="text/javascript">
    ...
    function submitAddBoxData() {
        ...
        $.ajax({
            type : "post",
            url : "<c:url value="/user/updUser"/>?userID="+editUserID,//存在ID为修改
            dataType : "json",
            data : data,
            contentType: "application/x-www-form-urlencoded; charset=utf-8",
            success : function(data) {
                ...
                } else if(data.status == 'name-error') {
                    swal("用户名重复!")
                } else {
                    swal("修改失败，请重试!");
                }
