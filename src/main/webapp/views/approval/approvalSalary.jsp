...
<body>
				...
				<div style="width: 90%; margin: 10px auto;">
					<form class="form-horizontal" id="addBoxForm">
						...
						<div class="form-group" style="display: none">
							...
							<div class="col-sm-10">
								<input type="text" class="DataInput form-control" id="srid">
							</div>
						</div>
					</form>
				</div>
    ...
    var dataTableConfig = {
        "ajax": {
            "url": "<c:url value="/approval/getApprovalSalaryList"/>?fresh=" + Math.random(),
            "type": "post",
            "data": function (d){
        ...
        "columnDefs": [
            ...
            {
                "render" : function(data, type, row, meta){
                    return '<button type="button" onclick="addTemp(\''+data.srid+'\')" class="btn btn-primary">审核</button>';
                },
                "targets" : 8
            },
            {
    ...
    function submitAddBoxData() {
        ...
        $.ajax({
            type : "post",
            url : "<c:url value="/approval/approvalSalary"/>",
            dataType : "json",
            data : data,
